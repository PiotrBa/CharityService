...
<head>
    ...
    <title>Admin-profile-categories-inactive</title>
...
<header class="header--form-page">
    ...
    <section class="form--steps-container">
        <ul class="btn1">
            <a href="/admin-profile-categories/active">Active Categories</a>
        </ul>
        <div class="table-container-categories">
            <c:if test="${empty categories}">
                <h1 class="center-text">No inactive categories found.</h1>
            </c:if>
                    ...
                    <c:forEach items="${categories}" var="category">
                        <tr>
                            ...
                            <td class="buttons-container">
                                <a href="/admin-profile-categories/inactive/edit?id=${category.id}">Update</a>
                            </td>
                            <td class="buttons-container">
                                <a href="/admin-profile-categories/inactive/delete?id=${category.id}">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
