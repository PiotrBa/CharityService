...
<head>
    ...
    <title>Admin-profile-institutions-inactive-edit</title>
...
<header class="header--form-page">
    ...
    <div class="slogan container container--90">
        <div class="login-style">
            <h2>Edit inactive institution</h2>
            <form:form method="post" modelAttribute="institution" class="form-edit-user">
                ...
                <div style="text-align: center;" class="form-buttons">
                    ...
                    <a href="/admin-profile-institutions/inactive" class="btn btn-secondary">Back</a>
                </div>
            </form:form>
        </div>
    </div>
