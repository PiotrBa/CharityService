...
<head>
    ...
    <title>Admin-profile-categories-inactive-delete</title>
    ...
    <div class="slogan container container--90">
        <div class="login-style">
            <form:form method="post" modelAttribute="category" class="form-edit-user">
                ...
                <div class="section--columns">
                    <h1>The deletion of ${category.name} will result in the removal of donations associated with it.</h1>
                </div>
                <div style="text-align: center;" class="form-buttons">
                    <form:button class="btn">Yes</form:button>
                    <a href="/admin-profile-categories/inactive" class="btn btn-secondary">No</a>
                </div>
            </form:form>
        </div>
    </div>
