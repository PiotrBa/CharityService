...
<header class="header--main-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="/homepage/#contact" class="btn btn--without-border">Contact</a></li>
        </ul>
    </nav>
...
<section class="stats">
    <div class="container container--85">
        <div class="stats--item">
            <em>${empty sumAllQuantities ? '0' : sumAllQuantities}</em>
            <h3>Donated bags</h3>
        ...
        <div class="stats--item">
            <em>${empty countAllDonations ? '0' : countAllDonations}</em>
            <h3>Gifts given</h3>
...
<footer>
    <div id="contact" class="contact">
        <h2>Contact us</h2>
        <h3>Contact form</h3>
        <form class="form--contact" action="/homepage/contact" method="post">
    ...
    <div class="bottom-line">
        ...
        <div class="bottom-line--icons">
            <a href="https://www.facebook.com" class="btn btn--small"><img src="<c:url value="/resources/images/icon-facebook.svg"/>"/></a>
            <a href="https://www.instagram.com" class="btn btn--small"><img src="<c:url value="/resources/images/icon-instagram.svg"/>"/></a>
        </div>
    </div>
</footer>
