...
<header class="header--form-page">
    ...
    <section class="form--steps-container">
        <ul class="btn1">
            <a href="/admin-profile-users/inactive">Inactive Users</a>
        </ul>
        <h2 class="centered-h2-with-icon">Administrators</h2>
        <div class="table-and-buttons-container">
            <div class="table-container">
                <c:if test="${empty admins}">
                    <h1 class="center-text">No active admins found.</h1>
                </c:if>
                        ...
                        <c:forEach items="${admins}" var="admin">
                            <tr>
                                ...
                                <td class="buttons-container">
                                    <a href="/admin-profile-users/active/update?id=${admin.id}">Edit</a>
                                </td>
                                <td class="buttons-container">
                                    <a href="/admin-profile-users/active/delete?id=${admin.id}">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
        ...
        <c:if test="${empty users}">
            <h1 class="center-text">No active users found.</h1>
        </c:if>
            ...
            <table>
                ...
                <c:forEach items="${users}" var="user">
                    <tr>
                        ...
                        <td>${user.active}</td>
                        <td class="buttons-container">
                            <a href="/admin-profile-users/active/update?id=${user.id}">Edit</a>
                        </td>
                        <td class="buttons-container">
                            <a href="/admin-profile-users/active/delete?id=${user.id}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
